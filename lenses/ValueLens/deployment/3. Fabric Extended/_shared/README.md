# _shared — core Fabric notebooks (mirrored from `1. Fabric`)

These are **byte-identical copies** of the seven core ingesters shipped under
[`1. Fabric/notebooks/`](../../1.%20Fabric/notebooks/). They live here so every
...
The **source of truth is `1. Fabric/notebooks/`**. Edit there, then run:
