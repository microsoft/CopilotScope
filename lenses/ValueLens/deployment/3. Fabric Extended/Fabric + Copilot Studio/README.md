...
[`../../1. Fabric/ValueLens - Fabric.pbit`](../../1.%20Fabric/ValueLens%20-%20Fabric.pbit)
...
| Notebook | Purpose |
|---|---|
| **`_core/*`** | Standard M365 Copilot ingesters. Byte-identical to those in `1. Fabric/notebooks/` (kept in sync by [`scripts/sync-shared.ps1`](../../../scripts/sync-shared.ps1)). |
...
1. Provision your **Fabric Lakehouse** and Entra app registration — see
   [`../../1. Fabric/README.md`](../../1.%20Fabric/README.md) for the parameters, RBAC roles, and Graph
...
[`../../1. Fabric/notebooks/`](../../1.%20Fabric/notebooks/), then run:
