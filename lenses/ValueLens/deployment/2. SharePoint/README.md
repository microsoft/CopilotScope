...
are in [`../2. Fabric/docs/DATA-DICTIONARY.md`](../1.%20Fabric/docs/DATA-DICTIONARY.md).
...
| Refresh hits 1 GB / 2-hour cap | Move to [`../2. Fabric/`](../1.%20Fabric/) for high-volume tenants. |
</details>
