...
![StudioLens for Copilot Studio — demo](../media/studiolens-demo.gif)
...
|---|---|---|---|
| **1 · Dataverse (Direct)** ⭐ | the **simplest** footprint — transcripts parsed live **in the Power BI model** (Power Query M); nothing else to stand up | a Dataverse environment + an org-data CSV | **[`1. Dataverse (Direct)/`](../deployment/1.%20Dataverse%20(Direct)/)** |
| **2 · Fabric** | **scheduled** Spark ingestion, larger volumes, and the **PPAC message-credit** pages | a Fabric capacity + Lakehouse | **[`2. Fabric/`](../deployment/2.%20Fabric/)** |
